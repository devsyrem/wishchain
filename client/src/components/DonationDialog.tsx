...
const DonationDialog = ({ wallet, wish, isOpen, onClose, onSuccess }: DonationDialogProps) => {
  ...
  // Make sure we only render the dialog content when it's open
  // This prevents issues with React hooks being conditionally rendered
  return (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-[#282830] border border-[#9945FF]/20 focus:border-[#9945FF] pl-2 pr-10 text-white"
                  placeholder="0.1"
                  step="0.01"
                  min="0.01"
                />
